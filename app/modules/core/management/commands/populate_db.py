...
from modules.core.management.commands.populate_db_helpers import (
    create_poke_institute_visits,
)
...
def populate(self, days_backwards: Optional[int] = None):
    ...
    create_poke_institute_visits(days_backwards=days_backwards)
